...
insert into roleentity (id, user_name, role) values (1, 'admin', 'ROLE_ADMIN');
insert into roleentity (id, user_name, role) values (2, 'user', 'ROLE_USER');
insert into roleentity (id, user_name, role) values (3, 'librarian', 'ROLE_LIBRARIAN');