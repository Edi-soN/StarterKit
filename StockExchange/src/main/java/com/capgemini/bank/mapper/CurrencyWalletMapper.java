...
public class CurrencyWalletMapper {
	...
	public static CurrencyWalletTo map(CurrencyWalletEntity currencyWalletEntity) {
        if (currencyWalletEntity != null) {
            return new CurrencyWalletTo(currencyWalletEntity.getId(), currencyWalletEntity.getCurrencyname(), currencyWalletEntity.getCurrencyamount());
        }
        return null;
    }
    ...
    public static CurrencyWalletEntity map(CurrencyWalletTo currencyWalletTo) {
        if (currencyWalletTo != null) {
            return new CurrencyWalletEntity(currencyWalletTo.getId(), currencyWalletTo.getCurrencyname(), currencyWalletTo.getCurrencyamount());
        }
        return null;
    }
